...
"==========================================================
map <silent><F7> :!ctags -R --c++-kinds=+p --fields=+iaS --extra=+q .<CR><CR>

"进行Tlist的设置
"TlistUpdate可以更新tags
noremap <silent> <leader>l :TlistToggle<CR> "按下,l就可以呼出了
"TODO: find your own ctags path
let Tlist_Auto_Open=1" open as default
...
map <silent><leader>r :ToggleRaibowParenthesis<CR>

"TODO:modify for your own path if you want to use language check, it is the syntax
"check plugin, remember? and for word check, only :set spell is fine.

"let g:languagetool_jar="/Users/zhaoshengzhang/Downloads/LanguageTool-2.5/languagetool-commandline.jar"
